    ...
    <footer className="relative overflow-hidden bg-black">
      ...
      <motion.div className="relative z-10 px-4 sm:px-8 lg:px-10 py-16 md:py-20 flex flex-col items-center text-center space-y-6"
        ...
        transition={{duration : 0.8}}>
          ...
          <div className="h-[3px] w-24 md:w-32 rounded-full bg-gradient-to-r from-[#0d58cc] via-cyn-300 to-emerald-400"/>
          ...
          <p className="text-xs text-gray-400">
            &copy; {new Date().getFullYear()} Vikash Rajput. All rights reserved.
