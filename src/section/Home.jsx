...
const socials = [
  ...
  {icon : FaLinkedin, label : "LinkedIn", href: "https://www.linkedin.com/in/vikash-rajput-788838317/" },
  {icon : FaGithub, label : "GitHub", href: "https://github.com/VikashRaj-cmd"}
]
        ...
        <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
          <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
            <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
              <motion.div
              className="mb-3 text-xl sm-2xl md:text-3xl lg:text-4xl font-semibold text-white tracking-wide min-h-[1.6em]"
              ...
              >
                I'm a B.Tech CSE student turning ideas into clean, modern, and high-impact web experiences — building responsive, fast, and scalable applications with passion and precision.
              </motion.p>
          ...
          <div className="relative hidden lg:block">
            ...
            style= {{
              right: "10px", width : "min(22vw, 41px)", height : "min(40vw, 76px)", borderRadius : "50%",
              filter : "blur(38px)", opacity: 0.32,
              background : "conic-gradient(from 0deg, #1cd8d2, #00bf8f, #302b63, #1cd8d2)"

            }} />

            <motion.img src={avator} alt="Vikash Rajput"
