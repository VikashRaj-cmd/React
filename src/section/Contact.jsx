          ...
          <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col">
              ...
              className={`p-3 rounded-md bg-white/10 border ${errors.service ? "border-red-500" : "border-gray-500"} text-white focus:outline-none focus:border-blue-500`}>
                ...
                <option value="mobile" className="text-black">Mobile Application Development</option>
            ...
            <div className="flex flex-col">
              <label className="mb-1">Share Your Idea <span className="text-red-500">*</span></label>
              <textarea name="idea"
              rows={5}
